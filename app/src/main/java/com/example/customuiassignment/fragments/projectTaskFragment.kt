package com.example.customuiassignment.fragments
 ...
 * [projectTaskFragment.OnFragmentInteractionListener] interface
...
class projectTaskFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =inflater.inflate(R.layout.fragment_project_task, container, false)

        var mAdapter : ProgressRecyclerAdapter = ProgressRecyclerAdapter()
        val linearLayoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        view.rvProjectTask.layoutManager = linearLayoutManager
        view.rvProjectTask.adapter = mAdapter
        return view
